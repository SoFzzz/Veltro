...
/**
 * Configuration properties for OpenAI API integration (B3-01).
 *
 * <p>Loads settings from {@code veltro.ai.openai.*} properties in application.yaml.
 * Provides a centralized configuration point for OpenAI Vision API parameters:
 * <ul>
 *   <li>{@code enabled} - whether AI vision is active</li>
 *   <li>{@code api-key} - OpenAI API key (from environment variable)</li>
 ...
 * the {@link OpenAiVisionClient} will return empty suggestions rather than
...
public class OpenAiConfig {
     ...
     * Supports: OpenAI, Moonshot/Kimi, Azure OpenAI, etc.
     ...
     * OpenAI Vision has size limits; files larger than this are rejected.
     * Default: 10 MB.
     */
