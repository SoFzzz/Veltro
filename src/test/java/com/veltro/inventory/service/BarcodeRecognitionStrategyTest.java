...
/**
 * Unit tests for {@link BarcodeRecognitionStrategy} (B3-01).
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("BarcodeRecognitionStrategy")
class BarcodeRecognitionStrategyTest {

    private BarcodeRecognitionStrategy strategy;

    @BeforeEach
    void setUp() {
        strategy = new BarcodeRecognitionStrategy();
    }
