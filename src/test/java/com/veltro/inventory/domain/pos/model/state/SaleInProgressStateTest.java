...
/**
 * Unit tests for {@link SaleInProgressState} (B2-01 - State Pattern).
 *
 * <p>Tests that IN_PROGRESS state allows item operations and confirm, but rejects void.
 */
class SaleInProgressStateTest {

    private SaleInProgressState state;
    private SaleEntity sale;

    @BeforeEach
    void setUp() {
        state = new SaleInProgressState();
        sale = new SaleEntity();
        sale.setId(1L);
